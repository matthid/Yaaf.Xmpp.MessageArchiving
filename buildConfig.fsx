...
let buildConfig =
 ...
 { BuildConfiguration.Defaults with
    ProjectName = "Yaaf.Xmpp.MessageArchiving"
    CopyrightNotice = "Yaaf.Xmpp.MessageArchiving Copyright © Matthias Dittrich 2015"
    ProjectSummary = "A XEP-0136 library implementation."
    ProjectDescription = "A XEP-0136 library implementation."
    ProjectAuthors = ["Matthias Dittrich"]
    NugetTags =  "fsharp csharp xmpp im message archiving library"
    PageAuthor = "Matthias Dittrich"
    GithubUser = "matthid"
    Version = release.NugetVersion
    NugetPackages =
      [ "Yaaf.Xmpp.MessageArchiving.nuspec", (fun config p ->
          { p with
